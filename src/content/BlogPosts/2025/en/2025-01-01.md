...
Our team published a paper "Automatic pipeline for information of curve graphs in papers based on deep learning" in the international journal 《International Journal of Machine Learning and Cybernetics》 (IF : 3.1, CAS Region III). The School of Computer Engineering and Science of Shanghai University was the first department.
