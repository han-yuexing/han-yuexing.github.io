...
<div style="display: flex; justify-content: center; gap: 25px; margin-top: 20px;">
  <div style="text-align: center;">
    <img src="/images/indexPic/2026/lrj.jpg" style="width: 140px; height: 140px;" alt="李睿杰" />
    <div style="margin-top: 10px;">李睿杰</div>
  </div>
  <div style="text-align: center;">
    <img src="/images/indexPic/2024/wan.png" style="width: 140px; height: 140px;" alt="万冠新" />
    <div style="margin-top: 10px;">万冠新</div>
  </div>
  <div style="text-align: center;">
    <img src="/images/indexPic/2026/hg.jpg" style="width: 140px; height: 140px;" alt="胡干" />
    <div style="margin-top: 10px;">胡干</div>
  </div>
</div>
